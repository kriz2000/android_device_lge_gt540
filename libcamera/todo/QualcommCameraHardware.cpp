...
static const str_map scenemode[] = {
    ...
    { CameraParameters::SCENE_MODE_THEATRE, CAMERA_SCENE_BACKLIGHT },
...
static int fb_fd = -1;
static int32_t mMaxZoom = 15;
static bool zoomSupported = true;
...
void QualcommCameraHardware::initDefaultParameters()
{
    ...
    if(zoomSupported){
        ...
        mParameters.set(CameraParameters::KEY_ZOOM_RATIOS,
                            "100,115,130,145,160,175,190,205,220,235,250,265,280,295,310,320");
    } else {
    ...
    mParameters.set(CameraParameters::KEY_TOUCH_AF_AEC,
                    CameraParameters::TOUCH_AF_AEC_ON);
...
status_t QualcommCameraHardware::setParameters(const CameraParameters& params)
{
    ...
    if((value != NOT_FOUND) && (value == CAMERA_SCENE_NORMAL)) {
